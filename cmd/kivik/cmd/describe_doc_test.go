...
func Test_describe_doc_RunE(t *testing.T) {
	...
	tests.Add("describe doc", func(*testing.T) any {
	...
	tests.Add("describe doc json", func(*testing.T) any {
		s := testy.ServeResponse(&http.Response{
			StatusCode: http.StatusOK,
			Header: http.Header{
				"Content-Type": []string{"application/json"},
	...
	tests.Add("describe doc header", func(*testing.T) any {
		s := testy.ServeResponse(&http.Response{
			StatusCode: http.StatusOK,
			Header: http.Header{
				"Content-Type":   []string{"application/json"},
	...
	tests.Add("describe doc verbose", func(*testing.T) any {
		s := testy.ServeResponse(&http.Response{
			StatusCode: http.StatusOK,
			Header: http.Header{
				"Content-Type":   []string{"application/json"},
