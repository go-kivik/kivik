...
func Test_ping_RunE(t *testing.T) {
	...
	tests.Add("full url on command line", func(*testing.T) any {
	...
	tests.Add("server only on command line", func(*testing.T) any {
		s := testy.ServeResponse(&http.Response{
	...
	tests.Add("Couch 1.7, up", func(*testing.T) any {
		s := testy.ServeResponse(&http.Response{
	...
	tests.Add("Couch 3.0, up", func(*testing.T) any {
		s := testy.ServeResponse(&http.Response{
	...
	tests.Add("Couch 3.0, down", func(*testing.T) any {
		s := testy.ServeResponse(&http.Response{
