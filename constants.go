...
const (
	...
	// BadAPICall indicates an improper use of the kivik API or the underlying
	// driver, before the network request was made. This can be though of as
	// similar to an HTTP status 400 / Bad Request, but is generated by kivik
	// rather than by the CouchDB server.
	StatusBadAPICall = 604
)
