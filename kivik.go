...
// DBsStats returns database statistics about one or more databases. If the
// driver does not natively support this operation, it will be emulated by
// in effect calling [DB.Stats] on each provided database.
