...
func callReplicate(ctx *kt.Context, client *kivik.Client, target, source, repID string, options kivik.Params) (*kivik.Replication, error) {
...
func testReplication(ctx *kt.Context, client *kivik.Client) {
	...
	ctx.Run("group", func(ctx *kt.Context) {
		...
		ctx.Run("Cancel", func(ctx *kt.Context) {
			...
			rep, err := callReplicate(ctx, client, dbtarget, "http://foo:foo@192.168.2.254/foo", replID, kivik.Params{"continuous": true})
