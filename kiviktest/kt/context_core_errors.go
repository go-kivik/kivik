...
func (c *ContextCore) CheckError(t *testing.T, err error) (match bool, success bool) {
	t.Helper()
...
// if they match.
func (c *ContextCore) IsExpected(t *testing.T, err error) bool {
	t.Helper()
...
func (c *ContextCore) IsSuccess(t *testing.T, err error) bool {
	t.Helper()
...
func (c *ContextCore) IsExpectedSuccess(t *testing.T, err error) bool {
	t.Helper()
