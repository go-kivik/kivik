...
type ExpectedClusterSetup struct {
	commonExpectation
	callback func(ctx context.Context, arg0 any) error
	arg0     any
}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedClusterSetup) WillExecute(cb func(ctx context.Context, arg0 any) error) *ExpectedClusterSetup {
	e.callback = cb
	return e
}
...
type ExpectedDBExists struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, options driver.Options) (bool, error)
	arg0     string
	ret0     bool
}
...
type ExpectedAllDBsStats struct {
	commonExpectation
	callback func(ctx context.Context, options driver.Options) ([]*driver.DBStats, error)
	ret0     []*driver.DBStats
}
...
func (e *ExpectedAllDBsStats) met(_ expectation) bool {
	return true
}

func (e *ExpectedAllDBsStats) method(v bool) string {
	if !v {
		return "AllDBsStats()"
	}
	options := formatOptions(e.options)
	return fmt.Sprintf("AllDBsStats(ctx, %s)", options)
}
...
type ExpectedDB struct {
	commonExpectation
	callback func(arg0 string, options driver.Options) (driver.DB, error)
	arg0     string
	ret0     *DB
}
...
type ExpectedDBUpdates struct {
	commonExpectation
	callback func(ctx context.Context, options driver.Options) (driver.DBUpdates, error)
	ret0     *Updates
}
...
type ExpectedGetReplications struct {
	commonExpectation
	callback func(ctx context.Context, options driver.Options) ([]driver.Replication, error)
	ret0     []*Replication
}
...
type ExpectedReplicate struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, arg1 string, options driver.Options) (driver.Replication, error)
	arg0     string
	arg1     string
	ret0     *Replication
}
