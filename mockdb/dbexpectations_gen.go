...
type ExpectedAllDocs struct {
	commonExpectation
	callback func(ctx context.Context, options driver.Options) (driver.Rows, error)
	ret0     *Rows
}
...
type ExpectedGet struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, options driver.Options) (*driver.Document, error)
	arg0     string
