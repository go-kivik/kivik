...
type ExpectedUpdate struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, arg1 string, arg2 string, arg3 interface{}, options driver.Options) (string, error)
	arg0     string
	arg1     string
	arg2     string
	arg3     interface{}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedUpdate) WillExecute(cb func(ctx context.Context, arg0 string, arg1 string, arg2 string, arg3 interface{}, options driver.Options) (string, error)) *ExpectedUpdate {
	e.callback = cb
	return e
}
...
type ExpectedExplain struct {
	commonExpectation
	callback func(ctx context.Context, arg0 interface{}, options driver.Options) (*driver.QueryPlan, error)
	arg0     interface{}
