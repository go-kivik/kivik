...
type ExpectedGet struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, options driver.Options) (driver.Rows, error)
	arg0     string
	ret0     *Rows
}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedGet) WillExecute(cb func(ctx context.Context, arg0 string, options driver.Options) (driver.Rows, error)) *ExpectedGet {
	e.callback = cb
	return e
}

// WillReturn sets the values that will be returned by the call to DB.Get().
func (e *ExpectedGet) WillReturn(ret0 *Rows) *ExpectedGet {
	e.ret0 = ret0
	return e
}
