...
type ExpectedGetAttachment struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, arg1 string, options driver.Options) (*driver.Attachment, error)
	arg0     string
	arg1     string
...
type ExpectedPutAttachment struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, arg1 *driver.Attachment, options driver.Options) (string, error)
	arg0     string
