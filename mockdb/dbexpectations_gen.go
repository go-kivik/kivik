...
type ExpectedCreateDoc struct {
	commonExpectation
	callback func(ctx context.Context, arg0 any, options driver.Options) (string, string, error)
	arg0     any
	ret0     string
	ret1     string
}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedCreateDoc) WillExecute(cb func(ctx context.Context, arg0 any, options driver.Options) (string, string, error)) *ExpectedCreateDoc {
	e.callback = cb
	return e
}
...
type ExpectedCreateIndex struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, arg1 string, arg2 any, options driver.Options) error
	arg0     string
	arg1     string
	arg2     any
}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedCreateIndex) WillExecute(cb func(ctx context.Context, arg0 string, arg1 string, arg2 any, options driver.Options) error) *ExpectedCreateIndex {
	e.callback = cb
	return e
}
...
type ExpectedDeleteIndex struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, arg1 string, options driver.Options) error
	arg0     string
	arg1     string
}
...
type ExpectedPut struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, arg1 any, options driver.Options) (string, error)
	arg0     string
	arg1     any
	ret0     string
}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedPut) WillExecute(cb func(ctx context.Context, arg0 string, arg1 any, options driver.Options) (string, error)) *ExpectedPut {
	e.callback = cb
	return e
}
...
// ExpectedUpdate represents an expectation for a call to DB.Update().
type ExpectedUpdate struct {
	commonExpectation
	callback func(ctx context.Context, arg0 string, arg1 string, arg2 string, arg3 any, options driver.Options) (string, error)
	arg0     string
	arg1     string
	arg2     string
	arg3     any
...
// WithOptions sets the expected options for the call to DB.Update().
func (e *ExpectedUpdate) WithOptions(options ...kivik.Option) *ExpectedUpdate {
	e.options = multiOptions{e.options, multiOptions(options)}
	return e
}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedUpdate) WillExecute(cb func(ctx context.Context, arg0 string, arg1 string, arg2 string, arg3 any, options driver.Options) (string, error)) *ExpectedUpdate {
	e.callback = cb
	return e
}

// WillReturn sets the values that will be returned by the call to DB.Update().
func (e *ExpectedUpdate) WillReturn(ret0 string) *ExpectedUpdate {
	e.ret0 = ret0
	return e
}

// WillReturnError sets the error value that will be returned by the call to DB.Update().
func (e *ExpectedUpdate) WillReturnError(err error) *ExpectedUpdate {
	e.err = err
	return e
}

// WillDelay causes the call to DB.Update() to delay.
func (e *ExpectedUpdate) WillDelay(delay time.Duration) *ExpectedUpdate {
	e.delay = delay
	return e
}

func (e *ExpectedUpdate) met(ex expectation) bool {
	exp := ex.(*ExpectedUpdate)
	if exp.arg0 != "" && exp.arg0 != e.arg0 {
		return false
	}
	if exp.arg1 != "" && exp.arg1 != e.arg1 {
	...
	if exp.arg3 != nil && !jsonMeets(exp.arg3, e.arg3) {
		return false
	}
	return true
}

func (e *ExpectedUpdate) method(v bool) string {
	if !v {
		return "DB.Update()"
	}
	arg0, arg1, arg2, arg3, options := "?", "?", "?", "?", formatOptions(e.options)
	if e.arg0 != "" {
		arg0 = fmt.Sprintf("%q", e.arg0)
	}
	if e.arg1 != "" {
	...
	if e.arg3 != nil {
		arg3 = fmt.Sprintf("%v", e.arg3)
	}
	return fmt.Sprintf("DB(%s).Update(ctx, %s, %s, %s, %s, %s)", e.dbo().name, arg0, arg1, arg2, arg3, options)
}
...
type ExpectedBulkDocs struct {
	commonExpectation
	callback func(ctx context.Context, arg0 []interface{}, options driver.Options) ([]driver.BulkResult, error)
	arg0     []interface{}
...
type ExpectedBulkGet struct {
	commonExpectation
	callback func(ctx context.Context, arg0 []driver.BulkGetReference, options driver.Options) (driver.Rows, error)
...
type ExpectedExplain struct {
	commonExpectation
	callback func(ctx context.Context, arg0 any, options driver.Options) (*driver.QueryPlan, error)
	arg0     any
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedExplain) WillExecute(cb func(ctx context.Context, arg0 any, options driver.Options) (*driver.QueryPlan, error)) *ExpectedExplain {
	e.callback = cb
	return e
}
...
type ExpectedFind struct {
	commonExpectation
	callback func(ctx context.Context, arg0 any, options driver.Options) (driver.Rows, error)
	arg0     any
	ret0     *Rows
}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedFind) WillExecute(cb func(ctx context.Context, arg0 any, options driver.Options) (driver.Rows, error)) *ExpectedFind {
	e.callback = cb
	return e
}
...
type ExpectedGetIndexes struct {
	commonExpectation
	callback func(ctx context.Context, options driver.Options) ([]driver.Index, error)
	ret0     []driver.Index
}
...
func (e *ExpectedOpenRevs) met(ex expectation) bool {
	exp := ex.(*ExpectedOpenRevs)
	if exp.arg0 != "" && exp.arg0 != e.arg0 {
		return false
	}
...
func (e *ExpectedOpenRevs) method(v bool) string {
	if !v {
		return "DB.OpenRevs()"
	}
	arg0, arg1, options := "?", "?", formatOptions(e.options)
	...
	return fmt.Sprintf("DB(%s).OpenRevs(ctx, %s, %s, %s)", e.dbo().name, arg0, arg1, options)
}
...
type ExpectedRevsDiff struct {
	commonExpectation
	callback func(ctx context.Context, arg0 any) (driver.Rows, error)
	arg0     any
	ret0     *Rows
}
...
// original function. Any values returned by the callback will be returned as
// if generated by the driver.
func (e *ExpectedRevsDiff) WillExecute(cb func(ctx context.Context, arg0 any) (driver.Rows, error)) *ExpectedRevsDiff {
	e.callback = cb
	return e
}
