...
func (d *db) CreateIndex(ctx context.Context, ddoc, name string, index interface{}, _ map[interface{}]interface{}) error {
...
func (d *db) GetIndexes(ctx context.Context, _ map[interface{}]interface{}) (indexes []driver.Index, err error) {
...
func (d *db) DeleteIndex(ctx context.Context, ddoc, name string, _ map[interface{}]interface{}) error {
...
func (d *db) Find(ctx context.Context, query interface{}, _ map[interface{}]interface{}) (driver.Rows, error) {
...
func (d *db) Explain(ctx context.Context, query interface{}, _ map[interface{}]interface{}) (*driver.QueryPlan, error) {
